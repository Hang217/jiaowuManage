...
<!--                     </li> -->
                    ...
                    <li>
                        <a  href="admin/getGonggao"  target="right"><i class="fa fa-qrcode "></i>公告管理</a>
                    </li>
                    </c:if>
<!--                     教师 -->
...
<!--                     <li> -->
<!--                         <a href="tea/add"  target="right"><i class="fa fa-bar-chart-o"></i>添加课程</a> -->
<!--                     </li> -->
                     <li>
                        <a  href="stu/getGonggao"  target="right"><i class="fa fa-qrcode "></i>公告查看</a>
                    </li>
                    </c:if>
